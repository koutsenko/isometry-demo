 ...
 *
 * Если этот код понадобится в другом проекте лишь для одного варианта
 * решения, имеет смысл избавиться от объекта `options` и всех условных
 * ветвей. Вынесите функцию в отдельный модуль, передавайте в неё только
 * контейнер сцены и возвращайте созданные элементы (grid, gridWrapper и
 * т.д.) — так интерфейс будет проще.
 */
